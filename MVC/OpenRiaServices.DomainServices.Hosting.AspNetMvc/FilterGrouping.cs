...
namespace System.Web.Http.Controllers
{
    ...
    internal class FilterGrouping
    {
        public FilterGrouping(IEnumerable<FilterInfo> filters)
        {
            ...
            ActionFilters = SelectAvailable<IActionFilter>(orderedCache, actionOverride);
            AuthorizationFilters = SelectAvailable<IAuthorizationFilter>(orderedCache, authorizationOverride);
            AuthenticationFilters = SelectAvailable<IAuthenticationFilter>(orderedCache, authenticationOverride);
            ExceptionFilters = SelectAvailable<IExceptionFilter>(orderedCache, exceptionOverride);
        }
